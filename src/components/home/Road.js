...
export default function Road() {
    ...
    return(
        <>
          <section className="bg-blue-soft" id="six">
            <div className="block-content big" style={{position: "relative"}}>
                <center>
                    <h3 className="h2" style={{marginBottom: "80px",color:"var(--color-gold)"}}>{t("road.Road_Title")}</h3>
                </center>

                <div className="road-map">
                    <span className="arrow"></span>
                    <span></span>
                    <div className="road-teaser fade-in">
                        <div>
                            <h4 className="h3">{t("road.Road_01")} 2021</h4>
                            <p><b>Token</b></p>
                    ...
                    <div className="road-teaser fade-in">
                        <div>
                            <h4 className="h3">{t("road.Road_02")} 2021</h4>
                            <p><b>Staking</b></p>
                    ...
                    <div className="road-teaser fade-in">
                        <div>
                            <h4 className="h3">{t("road.Road_03")}  2021</h4>
                            <p><b>Exchange</b></p>
                    ...
                    <div className="road-teaser fade-in">
                        <div>
                            <h4 className="h3">{t("road.Road_04")}  2021</h4>
                    ...
                    <div className="road-teaser fade-in">
                        <div>
                            <h4 className="h3">{t("road.Road_06")} 2022</h4>
                ...
                <div className="road">
                    <h4 className="h3">{t("road.Road_08")}  2022</h4>
                ...
                <div className="buttons center">
                    <a href={language === "en" ? whitepaperEng : whitepaperEsp} target="_blank" className="btn gold pdf">Whitepaper</a>
                </div>
                <div className="buttons center">
                    <a href={language === "en" ? presTokEng : presTokEsp} target="_blank" className="btn outline pres">Royal Token {t("buttons.Btn_Pres")}</a>
                    <a href={language === "en" ? presStaEng : presStaEsp} target="_blank" className="btn outline pres">Royal Staking {t("buttons.Btn_Pres")}</a>
                </div>

                <div className="social-share">
                    <ul>
                        <li><a href="https://www.facebook.com/NFT-Royal-Token-100558212373334" target="_blank" className="share-facebook"></a></li>
                        <li><a href="https://dappradar.com/binance-smart-chain/gambling/nft-royal-token" target="_blank" className="share-dappradar"></a></li>
                        <li><a href="https://twitter.com/nftroyaltokenes?s=11" target="_blank" className="share-twitter"></a></li>
                        <li><a href={language === "en" ? 'https://t.me/NFTroyaltokenOficial' : 'https://t.me/nftroyaltoken'} target="_blank" className="share-telegram"></a></li>
                        <li><a href="https://www.youtube.com/channel/UCw6acysO2eWSajMGw4lYNcg" target="_blank" className="share-youtube"></a></li>
                    </ul>
                </div>
            </div>
        </section>
        <section className="bg-blue">
            <div className="block-content">
                <div className="logos">
                    ...
                    <a href="https://cryptorank.io/news/nft-royal-token" target="_blank"><img src={log08} className="small" /></a>
                    <a href="https://coindataflow.com/en/prediction/nft-royal-token" target="_blank"><img src={log09} className="small" /></a>
                </div>
            </div>
        </section>
        </>
